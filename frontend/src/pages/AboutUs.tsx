  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 transition-colors duration-200">
      <div className="text-center mb-16">
        <h1 className="text-4xl font-bold text-gray-900 dark:text-white mb-4">About BookStore</h1>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          <div>
            ...
            <p className="text-gray-600 dark:text-gray-400 mb-4 leading-relaxed">
              Founded in 2020 by a group of avid readers, BookStore started as a small independent shop with a simple goal: to make great books accessible to everyone. 
            </p>
