          ...
          <div className="flex justify-between items-center h-16">
            ...
            <div className="flex items-center">
              <Link to="/" className="flex-shrink-0 flex items-center gap-2">
                ...
                <span className="font-bold text-xl text-gray-900 dark:text-white hidden sm:block">BookStore</span>
              </Link>
            </div>
      ...
      <footer className="bg-white dark:bg-gray-950 border-t border-gray-200 dark:border-gray-800 mt-12 transition-colors duration-200">
        <div className="max-w-7xl mx-auto py-12 px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            <div className="col-span-1 md:col-span-1">
              <div className="flex items-center gap-2 mb-4">
                <Logo className="w-8 h-8" />
                <span className="font-bold text-xl text-gray-900 dark:text-white">BookStore</span>
              </div>
              <p className="text-gray-500 dark:text-gray-400 text-sm">
                Your ultimate destination for discovering, reading, and sharing the world's best books.
              </p>
            </div>
            <div>
              <h3 className="text-sm font-semibold text-gray-900 dark:text-white tracking-wider uppercase mb-4">Shop</h3>
              <ul className="space-y-2">
                <li><Link to="/catalog" className="text-base text-gray-500 dark:text-gray-400 hover:text-indigo-600 dark:hover:text-indigo-400">All Books</Link></li>
          ...
          <div className="mt-8 border-t border-gray-200 dark:border-gray-800 pt-8 flex flex-col md:flex-row justify-between items-center transition-colors duration-200">
            <p className="text-base text-gray-400 dark:text-gray-500">&copy; 2026 BookStore. All rights reserved.</p>
